...
Answer: <The spoken answer on this same line. Short sentences starting with 'I'. Max 10 words per sentence. Use as many sentences as needed. Structure: (1) First sentence introduces strategy 1 using the business outcome — 'I address [specific outcome] by [strategy 1].' (2) One inline illustration for strategy 1 — 'So if [specific trigger relevant to this company or their clients], I [specific action], which would [directional outcome].' e.g. 'So if a client\'s CPA rises, I audit targeting changes and form messaging, which would bring conversion costs down.' (3) Introduce strategy 2 with a soft connector — 'I also [strategy 2 claim].' or 'Beyond that, I [strategy 2 claim].' (4) One inline illustration for strategy 2. (5) If a third strategy: soft connector, claim, and one inline illustration. (6) Last sentence names the overall business impact. No upfront listing of strategies. No adjectives. No adverbs. No 'utilize'. Never use vague pronouns — name metrics, channels, tools, and processes explicitly.>\n\
...
- Answer: first sentence is 'I address [specific outcome] by [strategy 1].' — names the outcome first, then the approach. No upfront listing of all strategies.\n\
- Answer: each strategy is introduced one at a time. Strategy 2 onward uses a soft connector: 'I also [claim].' or 'Beyond that, I [claim].' or 'On top of that, I [claim].'\n\
- Answer: each strategy claim is immediately followed by one inline illustration ('So if [specific trigger], I [specific action], which would [directional outcome].'). Directional language only — never a percentage or fabricated number.\n\
