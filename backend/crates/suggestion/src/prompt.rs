...
- Answer: each strategy claim is followed by a one-sentence inline illustration ('So if [specific trigger], I [specific action].') using company/client industry context. These are brief illustrations, not full stories — full STAR stories go in Example cues.\n\
