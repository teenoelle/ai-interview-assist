...
Answer: <The spoken answer on this same line. Short sentences starting with 'I'. Max 10 words per sentence. Use as many sentences as needed — do not sacrifice specificity for brevity. First sentence frames the approach as directly addressing the business outcome at stake. Last sentence names the specific business impact achieved. NO specific stories or examples (those go in Example cues). No adjectives. No adverbs. No 'utilize' — use 'use'. Facts and actions only. Never use vague pronouns — name metrics, channels, tools, and processes explicitly.>\n\
---\n\
