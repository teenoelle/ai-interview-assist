...
<style>
  ...
  .nq-title { font-size: 0.62rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: #334155; }
  .nq-chevron { font-size: 0.55rem; color: #1e293b; }
  .nq-refresh { padding: 0.3rem 0.5rem; background: transparent; border: none; border-left: 1px solid #1a2d4a; color: #334155; cursor: pointer; font-size: 0.85rem; transition: color 0.15s; }
  ...
  .nq-num { font-size: 0.58rem; font-weight: 800; color: #334155; flex-shrink: 0; margin-top: 0.1rem; }
  .nq-q { font-size: 0.73rem; color: #4d7494; font-style: italic; line-height: 1.35; }
  .nq-loading, .nq-empty { font-size: 0.72rem; color: #334155; font-style: italic; margin: 0; text-align: center; padding: 0.25rem 0; }
</style>
