...
<style>
  ...
  h2 { font-size: 1.1rem; font-weight: 700; color: #f1f5f9; margin: 0 0 0.25rem; }
  .subtitle { font-size: 0.78rem; color: #475569; margin: 0; }
  ...
  .item-label { font-size: 0.82rem; font-weight: 600; color: #94a3b8; }
  .item.done .item-label { color: #4ade80; }
  .item-detail { font-size: 0.68rem; color: #334155; line-height: 1.3; }
  .actions { padding: 0.75rem 1rem; border-top: 1px solid #1e293b; display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap; }
  .check-all-btn { padding: 0.35rem 0.75rem; background: transparent; border: 1px solid #334155; border-radius: 0.3rem; color: #64748b; font-size: 0.75rem; cursor: pointer; }
  .check-all-btn:hover { border-color: #64748b; color: #94a3b8; }
  .start-btn { flex: 1; padding: 0.5rem 1rem; background: #4ade80; border: none; border-radius: 0.4rem; color: #0a1f10; font-size: 0.85rem; font-weight: 700; cursor: pointer; transition: all 0.15s; }
  .start-btn:disabled { background: #1e293b; color: #334155; cursor: default; }
  .start-btn:not(:disabled):hover { background: #86efac; }
  .skip-btn { padding: 0.35rem 0.75rem; background: transparent; border: none; color: #334155; font-size: 0.72rem; cursor: pointer; }
